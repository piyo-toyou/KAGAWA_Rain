...
import Rain_Management_13 as rm
import send_mail_03 as sm
...
list_length, df_dict = rm.InputData(file_path, 30)
...
if flug:
    ...
    mail_to = "ogurahata.wataru@kiso.co.jp"
    mail_cc = "furuyama.shoichi@kiso.co.jp, maehama.yuta@kiso.co.jp"
